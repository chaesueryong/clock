  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative bg-[var(--bg-color-2)] rounded-2xl shadow-2xl w-[95%] sm:w-[90%] max-w-lg p-4 sm:p-6 animate-fade-in-up">
        <button
          onClick={onClose}
        ...
        <div className="flex justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          <div className="flex flex-col items-center">
            ...
            <input
              ...
              className="w-16 sm:w-20 h-14 sm:h-16 text-center text-xl sm:text-2xl font-semibold rounded-xl border-2 border-[var(--border-color-2)] bg-[var(--bg-color-7)] text-[var(--text-color-1)] focus:outline-none focus:ring-2 focus:ring-[var(--bg-color-4)]"
            />
          </div>
          <div className="flex flex-col items-center">
